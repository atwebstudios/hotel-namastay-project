      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <motion.div 
            ...
            className="fixed inset-y-0 right-0 max-w-[85vw] sm:max-w-xs md:max-w-sm w-full bg-[#f6faf6] shadow-2xl overflow-y-auto border-l border-[#bdc9c2] z-50"
          >
            <div className="flex flex-col justify-between min-h-full p-6">
              <div className="space-y-6">
                {/* Header with explicit Close Button */}
                <div className="pb-2 border-b border-[#dfe4e0] flex items-center justify-between">
                  <img 
                    src="/images/logo.png" 
              ...
              <div className="pt-6 mt-6 border-t border-[#dfe4e0] space-y-3 text-xs text-[#3e4944]">
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-[#006951] shrink-0" />
                ...
                <div className="flex items-center gap-2">
                  <MessageCircle className="w-4 h-4 text-[#006951] shrink-0" />
                  <a
                ...
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-[#006951] shrink-0" />
